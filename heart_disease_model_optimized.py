...
bert_model = TFBertModel.from_pretrained('bert-base-uncased', trainable=False)  # Frozen for efficiency
...
x_structured = tf.keras.layers.BatchNormalization()(x_structured)  # Batch Normalization
...
# Build and compile the model with early stopping and a learning rate scheduler
